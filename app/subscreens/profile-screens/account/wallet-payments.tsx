...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, Modal, Alert, ActivityIndicator, Image } from "react-native"
...
import SOLANA from "@/components/currency/SOL"
...
export default function WalletPaymentScreen() {
  ...
  const checkPinProtection = async () => {
    try {
      ...
      if (storedPin) {
        // If PIN protected, show PIN modal before loading wallet
        setShowPinModal(true)
        setPinAction("verify")
      } else {
        // If not PIN protected, load wallet directly
        loadWalletData()
      }
    } catch (error) {
      console.error("Error checking PIN protection:", error)
      loadWalletData() // Load wallet anyway if error
    }
  }
          ...
          <View style={styles.walletCard}>
            ...
            <View style={styles.balanceContainer}>
              ...
              <View style={styles.balanceAmountContainer}> 
                <USDC />
                {/* <SOLANA /> */}
                <Text style={styles.balanceAmount}>{userProfile?.walletBalance !== null ? userProfile?.walletBalance.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) : "0.00"}</Text> 
              </View>
              ...
              <View>
                ...
                {loading ? (
                  ...
                  <Text style={styles.balanceUsd}>
                    ...
                    {convertedAmount !== null ? convertedAmount.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) : "0.00"} {userCurrency}
                  </Text>
                )}
              </View>
            </View>
